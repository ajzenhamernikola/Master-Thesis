# Predviđanje najpogodnijeg SAT rešavača primenom metoda mašinskog učenja nad grafovskim reprezentacijama SAT formula (Predicting the best SAT solver using machine learning models on graph data for SAT)
