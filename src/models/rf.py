...
def search_for_the_best_model(x_train, y_train, x_val, y_val, n_estimators):
...
def save_training_data(r2_scores, rmse_scores, n_estimators, solver_names):
...
def main():
    ...
    r2_scores, rmse_scores = search_for_the_best_model(x_train, y_train, x_val, y_val, n_estimators)
    save_training_data(r2_scores, rmse_scores, n_estimators, solver_names)
