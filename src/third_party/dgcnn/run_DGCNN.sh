...
# input arguments
DATA="${1-SAT}"  # MUTAG, ENZYMES, NCI1, NCI109, DD, PTC, PROTEINS, COLLAB, IMDBBINARY, IMDBMULTI
fold=${2-1}  # which fold as testing data
test_number=${3-15}  # if specified, use the last test_number graphs as test data
